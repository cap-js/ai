...
import { inspectOnnxModelFile, validateOnnxEmbeddingModel } from './onnx-inspection.js';
...
async function validateEmbeddingModel(modelDir, model) {
  ...
  const inspection = await inspectOnnxModelFile(modelPath);
  validateOnnxEmbeddingModel(inspection, model);
