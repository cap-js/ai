...
async function readSentenceTransformerSemantics(context, repository, revision, filesByPath) {
  ...
  // modules.json defines the ordered execution pipeline. Accepting a module that this runtime
  // does not execute would silently produce embeddings with different semantics from the model.
